                        ...
                        <div class="md:flex-grow">
                            ...
                            <div class="inline-grid grid-cols-4 gap-x-3">
                                ...
                                <div class="flex flex-row">
                                    ...
                                    <form method="POST" action="{{ route('opinion.vote', ['id' =>$practice->id,'oId' =>$opinion->id, 'vote'=>1] )}}">
                                        <button>
                            ...
                            <form method="POST" action="{{ route('opinion.comment', ['id' =>$practice->id,'oId' =>$opinion->id] )}}">
                                ...
                                <section class="text-gray-600 body-font relative">
                                    <div class="container flex">
                                        <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg pb-8 px-8 flex flex-col relative z-10 shadow-md">
