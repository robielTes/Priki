            ...
            @forelse($practices as $practice)
                ...
                <div class="p-4 lg:w-1/3">
                    <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <h2 class="text-xs font-medium italic text-gray-400 mb-1">{{ $practice->updated_at->translatedFormat('l jS F Y')}}</h2>
                        <p class="mb-3 prikiDescription">{{$practice->description}}</p>
                        <a class="text-indigo-500 inline-flex items-center" href="{{ route('practices.show', ['id' => $practice->id] ) }}">Learn More
